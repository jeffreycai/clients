...
class Queue extends BaseQueue {
  ...
  static function findAllWithPage($page, $entries_per_page, $orderby = 'created_at', $order = 'ASC') {
    global $mysqli;
  ...
  static function countAllQueued ($type = null) {
    global $mysqli;
    $type_condition = is_null($type) ? '' : " AND type='" . $type . "'";
    $query = "SELECT COUNT(*) as 'count' FROM queue WHERE status=" . self::STATUS_QUEUED . $type_condition;
